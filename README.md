...
> *להוסיף: צילום Dashboard + DayDetail + מפה*

לבדיקת הזרימה המרכזית ניתן להיכנס ל-[letsexploring.com](https://letsexploring.com) וליצור טיול דמו — אין צורך בחשבון כדי לחקור.
