...
const en = {
  ...
  createTripFailed: 'Could not create trip — check Supabase anonymous auth is enabled',
...
const he: typeof en = {
  ...
  createTripFailed: 'לא ניתן ליצור טיול — ודא שהתחברות אנונימית מופעלת ב-Supabase',
