...
const en = {
  appName: 'Trippy',
  appTagline: 'Easier trips, better together.',
  ...
  setupTitle: 'Settings',
  setupSub: 'Customize for your group',
  ...
  aiSugSub: 'Local spots worth stopping at, near your route',
  ...
  registerNudgeTitle: 'Keep this trip?',
  registerNudgeSub: 'Sign up free — your trips follow you everywhere.',
  ...
  quickAdd: 'Quick Add',
  noUpcomingEvents: 'Nothing lined up right now — enjoy it.',
  darkMode: 'Dark Mode',
  ...
  noTripsSub: 'Name a destination and set the dates — that\'s the hardest part done.',
  ...
  // Crew screen
  gatherTheTribe: 'Bring the crew',
  gatherSubtitle: 'The more people in, the better the trip.',
  ...
  noActivitiesYet: 'This day is empty — add something or leave it free.',
  startPlanningCta: 'Start with Day 1 — a restaurant, a hike, or just a rough idea.',
  planDay1: 'Plan Day 1',
  ...
  emptyTrips: 'No trips yet — where are you headed?',
...
const he: typeof en = {
  ...
  aiSugSub: 'מקומות שווים לעצירה, ליד המסלול שלכם',
  ...
  registerNudgeTitle: 'רוצה לשמור את הטיול?',
  registerNudgeSub: 'הרשמה חינמית — הטיולים שלכם תמיד אתכם.',
  ...
  noUpcomingEvents: 'אין כלום מתוכנן עכשיו — תיהנו מהזמן.',
  darkMode: 'מצב כהה',
  lightMode: 'מצב בהיר',
  ...
  crewNoMembers: 'בינתיים רק אתה — רוצה לצרף עוד מישהו?',
  ...
  noExpensesYet: 'עדיין אין הוצאות — הוסף את ההוצאה הראשונה',
  paid: 'שילם',
  person: 'אדם',
  ...
  estimatedTravelTime: '🚗 זמן נסיעה משוער',
  moveToTime: 'העבר ל',
  confirmMove: 'אשר',
  onlineBadge: '● מחובר',
  ...
  noTripsSub: 'בחרו יעד ותאריכים — זה כל מה שצריך כדי להתחיל.',
  ...
  noLink: 'לא הצלחנו ליצור קישור — נסה שוב',
  ...
  deleteAccountConfirm: 'פעולה זו תמחק לצמיתות את חשבונך ונתוניך האישיים. תוכן הטיול המשותף (פעילויות, הוצאות, הערות) יישאר גלוי למשתתפים האחרים. לא ניתן לבטל. להמשיך?',
  ...
  settleUp: 'סגירת חשבונות',

  // V2 — Trip DNA Card
  dnaBtnShare: '✨ שתף כרטיס DNA',
  dnaGenerating: 'מייצר כרטיס DNA לטיול…',
  dnaShareFailed: 'השיתוף לא הצליח — נסה לשמור את התמונה',
  ...
  // Crew screen
  gatherTheTribe: 'הביאו את כולם',
  gatherSubtitle: 'ככל שיש יותר אנשים בתוכנית, הטיול יוצא טוב יותר.',
  ...
  couldNotCreateInvite: 'לא הצלחנו ליצור קישור הזמנה',
  ...
  noActivitiesYet: 'היום ריק — הוסיפו משהו או השאירו אותו פנוי.',
  startPlanningCta: 'התחילו ביום 1 — מסעדה, טיול, או סתם רעיון ראשוני.',
  planDay1: 'תכנן יום 1',
  ...
  settings: 'הגדרות',
  wishlist: 'משאלות',
  wishlistTitle: 'רשימת המשאלות',
  wishlistEmpty: 'עדיין ריק — הוסף מקומות שאתה רוצה לבקר בהם',
  wishlistAdd: 'הוסף לרשימת המשאלות',
  ...
  emptyTrips: 'אין טיולים עדיין — לאן נוסעים?',

  // Home hero
  homeHeroTitle: 'לאן\nנוסעים?',
  homeHeroSub: 'כל הטיולים שלכם, במקום אחד.',
  homeStatementEmpty: 'נתכנן את הראשון יחד.',
