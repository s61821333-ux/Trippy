...
const en = {
  ...
  pdfNoEvents: 'No events scheduled.',
  pdfStarts: 'starts',
  ...
  hideTravelVault: 'Hide Travel Vault',
  hideTravelVaultSub: 'Removes the Travel Vault section from settings',
  ...
  deleteAccountConfirm: 'This will permanently delete your account and personal data. Shared trip content (events, expenses, notes) will remain for other participants. This cannot be undone. Continue?',
...
const he: typeof en = {
  ...
  tripExportedPDF: 'הטיול יוצא כ-PDF ✓',
  pdfComingSoon: 'ייצוא PDF בגרסה v2',
  pdfNoEvents: 'אין אירועים מתוכננים.',
  pdfStarts: 'מתחיל',
  pdfPopupBlocked: 'אפשר חלונות קופצים לייצוא PDF',
  ...
  webViewWarning: 'אתה בדפדפן מוטמע. לחץ על התפריט (⋮ או …) ובחר "פתח ב-Chrome" או "פתח בדפדפן" כדי להתחבר עם Google.',
  ...
  displayLabel: 'תצוגה',
  hideTravelVault: 'הסתרת כספת מסע',
  hideTravelVaultSub: 'מסיר את קטע כספת המסע מההגדרות',
  ...
  deleteAccount: 'מחיקת הנתונים שלי',
  deleteAccountConfirm: 'פעולה זו תמחק לצמיתות את חשבונך ונתוניך האישיים. תוכן הטיול המשותף (אירועים, הוצאות, הערות) ישאר גלוי לשאר המשתתפים. לא ניתן לבטל פעולה זו. להמשיך?',
