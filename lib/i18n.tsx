...
const he: typeof en = {
  ...
  registerNudgeTitle: 'אהבת את מה שאתה רואה?',
  registerNudgeSub: 'שמור את הטיולים שלך וקח אותם לכל מקום — בחינם.',
  ...
  // Crew screen
  gatherTheTribe: 'תביא את כולם',
  gatherSubtitle: 'הזמן את האנשים שלך — מתכננים ביחד, מטיילים ביחד.',
