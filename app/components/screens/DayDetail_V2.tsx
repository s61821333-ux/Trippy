...
const CATS_EXTENDED: [Category, string, string, string][] = [
  ...
  ['boat',        'ship',     'Boat',         'סירה'],
  ['water_sports','wave',     'Water Sports', 'ספורט מים'],
  ['ski',         'arrow',    'Ski',          'סקי'],
  ['aerial',      'plane',    'Aerial',       'אוויר'],
  ['golf',        'sun',      'Golf',         'גולף'],
  ['safari',      'compass',  'Safari',       'ספארי'],
  ['nightlife',   'music',    'Nightlife',    'בילוי לילי'],
  ['winery',      'cup',      'Winery',       'יקב'],
  ['cooking',     'fork',     'Cooking',      'בישול'],
  ['theater',     'film',     'Theater',      'תיאטרון'],
  ['cinema',      'film',     'Cinema',       'קולנוע'],
  ['art',         'camera',   'Art',          'אמנות'],
  ['festival',    'ticket',   'Festival',     'פסטיבל'],
  ['shopping',    'tag',      'Shopping',     'קניות'],
  ['market',      'fork',     'Market',       'שוק'],
  ['spa',         'hot',      'Spa',          'ספא'],
