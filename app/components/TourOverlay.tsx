...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    titleHe: 'הזמינו בקישור',
    body: 'Open Settings → Invite to share a link with friends. Everyone sees and edits the same trip in real time.',
    bodyHe: 'פתחו הגדרות ← הזמנה לשיתוף קישור עם חברים. כולם רואים ועורכים את אותו טיול בזמן אמת.',
