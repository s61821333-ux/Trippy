...
- Name: uiux\03-day-view.spec.ts >> Day View (Explore) >> category icons: Concert and Theme Park have distinct icons (not both sparkle)
- Location: tests\uiux\03-day-view.spec.ts:64:7
