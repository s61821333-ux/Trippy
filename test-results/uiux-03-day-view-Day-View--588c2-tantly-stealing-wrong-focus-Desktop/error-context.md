...
- Name: uiux\03-day-view.spec.ts >> Day View (Explore) >> Add Event sheet opens without instantly stealing wrong focus
- Location: tests\uiux\03-day-view.spec.ts:40:7
