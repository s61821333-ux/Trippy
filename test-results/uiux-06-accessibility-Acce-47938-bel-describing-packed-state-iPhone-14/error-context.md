...
- Name: uiux\06-accessibility.spec.ts >> Accessibility & Layout >> Packing list items have aria-label describing packed state
- Location: tests\uiux\06-accessibility.spec.ts:43:7
